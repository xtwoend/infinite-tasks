...
+function ($) { "use strict";
	...
	$.ajaxSetup({ 
  	...
  	$(function(){
		...
		$('[data-ride="datatables"].static').each(function() {
		...
		// select2
		$("select[data-item='select2-tags'].select2").length && $("select[data-item='select2-tags'].select2").select2({
			tags: true,
			tokenSeparators: [','],
		...
		$("select[data-item='select2'].select2").length && $("select[data-item='select2'].select2").select2({
		    theme: "bootstrap"
		});
		...
		// upload single
		$(document).on('change', 'input[type="file"].fileupload-multiple', function(e){
			e && e.preventDefault();
			var self = $(this),
	        ...
	        $.ajax({
	            ...
	            processData: false,
	            beforeSend: function(){
	            	$('div[data-item="attachment"]').append('<i class="fa fa-spin fa-spinner show inline" id="spin"></i>');
	            },
	            complete : function(res) {
	                ...
	                $('div[data-item="attachment"]').append(html);	               
	                $('i.fa.fa-spin.fa-spinner').remove();                

	                $('div[data-item="attachment"]').find('.btn.remove-item').on('click', function(e){
	                	e.preventDefault();
